...
public class OnAdTask extends Script implements BotTask{
	...
	public void onDocumentLoadedInFrame(FrameLoadEvent event) {
		...
		if (event.isMainFrame()) {
			...
			while (true) {
				ElementRect rect = findElementHighestWeight(event.getFrameId());
				
				//DOMNodeAtPoint p = browser.getNodeAtPoint(1, 1);
