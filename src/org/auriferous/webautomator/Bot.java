...
import org.auriferous.webautomator.gui.swing.JBotFrame;
import org.auriferous.webautomator.internal.executor.ScriptExecutionListener;
import org.auriferous.webautomator.internal.executor.ScriptExecutor;
import org.auriferous.webautomator.internal.loader.CachedScriptLoader;
import org.auriferous.webautomator.internal.loader.ScriptLoader;
import org.auriferous.webautomator.internal.loader.ScriptLoaderImpl;
...
import org.auriferous.webautomator.shared.data.DataStore;
import org.auriferous.webautomator.shared.data.config.ClassDataStore;
import org.auriferous.webautomator.shared.data.config.Configurable;
...
import org.auriferous.webautomator.shared.data.library.xml.XMLScriptLibrary;
import org.auriferous.webautomator.shared.data.library.xml.XMLScriptManifest;
import org.auriferous.webautomator.shared.tabs.Tabs;
...
public class Bot implements ScriptExecutionListener, Configurable {
	...
	public Bot(String args[], boolean createGUI) {
		...
		XMLScriptManifest manifest = new XMLScriptManifest("bin", "org.auriferous.webautomator.scripts.googler.Googler", "3", "Googler", "1.0", "RAARR", "bin");
		scriptLibrary.addScript(manifest, true);
		
		XMLScriptManifest manifest2 = new XMLScriptManifest("bin", "org.auriferous.webautomator.scripts.blogscripts.AdClicker", "4", "Ad Clicker", "1.0", "RAARR", "bin");
		scriptLibrary.addScript(manifest2, true);
		
		XMLScriptManifest manifest3 = new XMLScriptManifest("bin", "org.auriferous.webautomator.scripts.tests.TestAdClicking", "5", "Test Script", "1.0", "RAARR", "bin");
		scriptLibrary.addScript(manifest3, true);
		
		XMLScriptManifest manifest4 = new XMLScriptManifest("bin", "org.auriferous.webautomator.scripts.internal.debug.TestElementSearch", "6", "Test Element Search", "1.0", "RAARR", "bin");
		scriptLibrary.addScript(manifest4, true);
		
		XMLScriptManifest manifest5 = new XMLScriptManifest("bin", "org.auriferous.webautomator.scripts.tests.TestAdChecking", "6", "Test Ad Checking", "1.0", "RAARR", "bin");
		scriptLibrary.addScript(manifest5, true);
		
		XMLScriptManifest manifest6 = new XMLScriptManifest("bin", "org.auriferous.webautomator.scripts.blogscripts.Shufflr", "7", "Shufflr", "1.0", "RAARR", "bin");
